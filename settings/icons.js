...
export const ICONS = {
  ...
  // Блок «Блоки» (страница карточек, docs/WIDGET-SDK.md manifest.icon): один простой глиф на виджет.
  // Эквалайзер: столбики разной высоты
  eq: svg('<line x1="3" y1="12" x2="3" y2="8"/><line x1="8" y1="13" x2="8" y2="3"/><line x1="13" y1="12" x2="13" y2="6"/>'),
  // Фото: рамка с солнцем и горой
  photo: svg('<rect x="2" y="3" width="12" height="10" rx="1"/><circle cx="6" cy="6.8" r="1.1"/><path d="M2.6 11.8 L6.2 8.2 L8.8 10.6 L10.8 8.6 L13.4 11.2"/>'),
  // Фокус-таймер: концентрические кольца
  focus: svg('<circle cx="8" cy="8" r="5.5"/><circle cx="8" cy="8" r="2.6"/>'),
  // Погода: облако
  weather: svg('<path d="M4.6 11.2 A2.4 2.4 0 0 1 4.9 6.4 A3.4 3.4 0 0 1 11.5 6.9 A2.2 2.2 0 0 1 11.2 11.2 Z"/>'),
  // Календарь: рамка, полоса и ушки
  calendar: svg('<rect x="2" y="3.3" width="12" height="10.5" rx="1"/><line x1="2" y1="6.6" x2="14" y2="6.6"/><line x1="5.2" y1="2" x2="5.2" y2="4.2"/><line x1="10.8" y1="2" x2="10.8" y2="4.2"/>'),
  // Запуск: рамка со стрелкой наружу
  launch: svg('<rect x="2.3" y="2.3" width="11.4" height="11.4" rx="1.2"/><path d="M6.2 9.8 L10.2 5.8"/><path d="M7.2 5.8 H10.2 V8.8"/>'),
  // Граф: три узла и связи
  graph: svg('<circle cx="4" cy="4.5" r="1.3"/><circle cx="12" cy="4.5" r="1.3"/><circle cx="8" cy="12" r="1.3"/><line x1="4" y1="4.5" x2="12" y2="4.5"/><line x1="4" y1="4.5" x2="8" y2="12"/><line x1="12" y1="4.5" x2="8" y2="12"/>'),
  // Системные показатели: растущие столбики
  stats: svg('<line x1="2" y1="13.5" x2="14" y2="13.5"/><rect x="3" y="9.2" width="2.1" height="4.3"/><rect x="6.9" y="6.2" width="2.1" height="7.3"/><rect x="10.8" y="3.2" width="2.1" height="10.3"/>'),
  // Плеер: круг с треугольником play
  player: svg('<circle cx="8" cy="8" r="5.5"/><path d="M6.7 5.7 L11 8 L6.7 10.3 Z"/>'),
  // Задачи планировщика: список строк
  tasks: svg('<line x1="3" y1="4.2" x2="13" y2="4.2"/><line x1="3" y1="8" x2="13" y2="8"/><line x1="3" y1="11.8" x2="9" y2="11.8"/>'),
};
...
export const UTIL = {
  ...
  // Сворачивание/разворачивание карточек (например «Дополнительно» в панели задач).
  "chevron-up": svg('<path d="M4 10 L8 6 L12 10"/>'),
  "chevron-down": svg('<path d="M4 6 L8 10 L12 6"/>'),
  // Закрыть/убрать (заменяет символ ✕ в списках модулей верхней строки/панели задач).
  close: svg('<line x1="4" y1="4" x2="12" y2="12"/><line x1="12" y1="4" x2="4" y2="12"/>'),
  // Назад (заменяет символ ← в хлебных крошках страницы «Блоки»).
  "arrow-left": svg('<line x1="12.5" y1="8" x2="4" y2="8"/><path d="M7.2 4.8 L4 8 L7.2 11.2"/>'),
  // Переместить выше/ниже в списках (заменяет символы ▲/▼ в панели задач).
  "arrow-up": svg('<line x1="8" y1="12.5" x2="8" y2="4" /><path d="M4.8 7.2 L8 4 L11.2 7.2"/>'),
  "arrow-down": svg('<line x1="8" y1="3.5" x2="8" y2="12" /><path d="M4.8 8.8 L8 12 L11.2 8.8"/>'),
};
